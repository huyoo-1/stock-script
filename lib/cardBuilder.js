...
function buildCloseCard({ date, indices, breadth, margin, etf, history30, conclusion }) {
  const elements = [];
...
module.exports = { buildIntradayCard, buildCloseCard, maybeChunk, md, hr, columnSet };
